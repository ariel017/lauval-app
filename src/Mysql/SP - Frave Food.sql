...
INSERT INTO Person (firstName, lastName, phone, image) VALUE ('lauval', 'admin', '986587000', 'without-image.png');
	
INSERT INTO users (users, email, password, persona_id, rol_id, notification_token) VALUE ('lauval', 'lauval@gmail.com', '$2a$12$oENUlUoV7ZMDHwPB/am7NenwrRhNu9Opq8HwiOtfxt3R8fpcvaVjO', LAST_INSERT_ID(), 1, 'f_jxSNweTpKiS2WwvOQaWN:APA91bFFxJfxB_D-9aosBEPmhOWqaVDV9a_aTrUOKw1Bb4z3I-T5eumAF75JDB-gU3Li65zxBjE_BdVytTrwCoxxkk1THLx4J4AT0DIT0D79E14ZzWrU4QhPgnWFSZPegW3sCM9PSEiB');

INSERT INTO categories (category, description) VALUES
       ('Drinks', 'Description Drinks'),
       ('Fast Food', 'Fast Food Description'),
       ('Soda', 'Soda Description'),
       ('Juices', 'Jucies description'),
       ('Pizza', 'pizza description'),
       ('Snacks', 'Snacks Description'),
       ('Salad', 'Salad Description'),
       ('Ice Cream', 'Ice Cream description');
